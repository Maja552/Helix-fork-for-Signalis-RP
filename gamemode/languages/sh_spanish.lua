...
LANGUAGE = {
	...
	cmdPlyWhitelistFaction = "Permite el acceso de alguien a la facción especificada (lista blanca).",
	cmdCharGetUp = "Intenta levantarte después de haber caído.",
	cmdPlyUnwhitelistFaction = "Elimina el acceso de alguien a la facción especificada.",
