...
LANGUAGE = {
	...
	cmdPlyWhitelistFaction = "Permet à quelqu'un de créer un personnage dans la faction spécifiée.",
	cmdCharGetUp = "Tentatives de se relever après être tombé.",
	cmdPlyUnwhitelistFaction = "Interdit à quelqu'un de créer un personnage dans la faction spécifiée.",
