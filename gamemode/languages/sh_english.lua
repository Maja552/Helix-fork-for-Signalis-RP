...
LANGUAGE = {
	...
	cmdPlyWhitelistFaction = "Allows someone to create a character in the specified faction.",
	cmdCharGetUp = "Attempts to stand back up after having fallen over.",
	cmdPlyUnwhitelistFaction = "Disallows someone to create a character in the specified faction.",
	...
	nameHint = "Don't set nicknames here.",
	alreadyInWhitelist = "This steamid is already whitelisted",
	cmdPlyWhitelistClass = "Allows someone to create a character in the specified class.",
	cmdPlyWhitelistClassSteamid64 = "Allows someone to create a character in the specified class (finds played by steamid64).",
	whitelistAdded = "Whitelisted successfully.",
	class_whitelist = "%s has whitelisted %s for the %s class.",
