...
LANGUAGE = {
	...
	cmdPlyWhitelistFaction = "Permite que alguém crie um personagem na facção especificada.",
	cmdCharGetUp = "Tenta se levantar após ter caído.",
	cmdPlyUnwhitelistFaction = "Tira a permissão de alguém para criar um personagem na facção especificada.",
