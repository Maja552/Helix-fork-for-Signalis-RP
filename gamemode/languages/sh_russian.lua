...
LANGUAGE = {
	...
	cmdPlyWhitelistFaction = "Выдать доступ игроку к созданию персонажа в указанной фракции",
	cmdCharGetUp = "Попытаться встать после падения.",
	cmdPlyUnwhitelistFaction = "Забрать доступ у игрока к созданию персонажа в указанной фракции.",
