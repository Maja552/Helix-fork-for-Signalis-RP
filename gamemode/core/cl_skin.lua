...
do
	...
	local bRollover = file.Exists("sound/eternalis/ui/cannot.wav", "GAME")
	local bPress = file.Exists("sound/eternalis/ui/select.wav", "GAME")
	...
	sound.Add({
		...
		level = 80,
		pitch = {95, 105},
		sound = bRollover and "eternalis/ui/cannot.wav" or "ui/buttonrollover.wav"
	})
